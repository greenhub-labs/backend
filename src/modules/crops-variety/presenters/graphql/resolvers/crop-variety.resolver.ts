...
import { GetAllCropsVarietiesQuery } from 'src/modules/crops-variety/application/queries/get-all-crops-varieties/get-all-crops-varieties.query';
...
import { GetCropVarietyByScientificNameQuery } from 'src/modules/crops-variety/application/queries/get-crop-variety-by-scientific-name/get-crop-variety-by-scientific-name.query';
