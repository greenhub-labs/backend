    ...
    if (params.emitEvent !== false) {
      this.addDomainEvent(
        new CropVarietyCreatedDomainEvent({
          ...
          plantingSeasons: this._plantingSeasons.map((s) => s.value),
          harvestSeasons: this._harvestSeasons.map((s) => s.value),
        }),
      );
    }
  }
  ...
  update(
    ...
    updated.addDomainEvent(
      new CropVarietyUpdatedDomainEvent({
        ...
        name: updated._name,
        scientificName: updated._scientificName,
        type: updated._type.value,
        description: updated._description,
        averageYield: updated._averageYield,
        ...
        maxIdealPh: updated._maxIdealPh,
        compatibleWith: updated._compatibleWith,
        incompatibleWith: updated._incompatibleWith,
        plantingSeasons: updated._plantingSeasons.map((s) => s.value),
        harvestSeasons: updated._harvestSeasons.map((s) => s.value),
      }),
    );
    return updated;
  }
