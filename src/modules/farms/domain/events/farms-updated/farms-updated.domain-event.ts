...
/**
 * FarmsUpdatedDomainEvent
 * Emitted when a __name__ is updated in the system.
 * You can add more properties as needed for your domain.
 */
export class FarmsUpdatedDomainEvent implements DomainEvent {
  ...
  /**
   * Creates a new FarmsUpdatedDomainEvent
