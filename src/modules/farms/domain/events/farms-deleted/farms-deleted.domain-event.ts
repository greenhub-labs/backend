...
/**
 * FarmsDeletedDomainEvent
 * Emitted when a __name__ is deleted in the system.
 * You can add more properties as needed for your domain.
 */
export class FarmsDeletedDomainEvent implements DomainEvent {
  ...
  /**
   * Creates a new FarmsDeletedDomainEvent
